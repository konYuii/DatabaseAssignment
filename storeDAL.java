...
public class storeDAL {
    ...
    {
        String sql = "select name,introduction,label,image from store where id=?";
        try {
            PreparedStatement ps = connection.prepareStatement(sql);
            ps.setInt(1,id);
            ResultSet rs = ps.executeQuery();
    ...
    public storeModel GetModelSelf(int id)
    {
        String sql = "select name,introduction,label,password,image from store where id=?";
        try {
            PreparedStatement ps = connection.prepareStatement(sql);
            ps.setInt(1,id);
            ResultSet rs = ps.executeQuery();
