...
function AddLeftLi(i)
{
    ...
    if(stores[i].image == undefined)
    {
        NLI.innerHTML = "\n" +
            "                    <figure class=\"effect-oscar\">\n" +
            "                        <img src=\"assets/search/images/home-images/image-1.jpg\" alt=\"\" class=\"img-responsive\"/>\n" +
            "                        <figcaption>\n" +
    ...
    else
    {
        NLI.innerHTML = "\n" +
            "                    <figure class=\"effect-oscar\">\n" +
            "                        <img src=\"" + 'http://localhost:8080/'+ stores[i].image + "\" alt=\"\" class=\"img-responsive\"/>\n" +
            "                        <figcaption>\n" +
            "                            <h2><span>" + stores[i].name + "</span></h2>\n" +
            "\n" +
            "                            <p>"+ stores[i].introduction + "</p>\n" +
...
function AddRightLi(i)
{
    ...
    NLI.innerHTML ="\n" +
        "                    <figure class=\"effect-oscar\">\n" +
        "\n" +
        "                        <img src=\"assets/search/images/home-images/image-2.jpg\" alt=\"\" class=\"img-responsive\"/>\n" +
        "\n" +
        "                        <figcaption>\n" +
        "\n" +
        "                            <h2><span>" + stores[i].name +"</span></h2>\n" +
